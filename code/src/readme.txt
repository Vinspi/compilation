...
suppression des fichier objet ainsi que des executables : make clean

les fichiers : analyseurLL1 analyseurLL1_synt analyseurLL1_asynt sont des doublons de code, seul leur paramètrage diffère.
